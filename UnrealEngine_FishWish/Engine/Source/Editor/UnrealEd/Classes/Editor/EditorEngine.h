...
public:
	...
	UNREALED_API virtual void SwitchPrimaryPIE(UGameViewportClient* InViewport) override;
	UNREALED_API virtual void SwitchPrimaryPIE(int PrimaryPIEIndex) override;
...
private:
	...
	// BEGIN META SECTION - VR MultiPlayer
	UNREALED_API void SwitchPrimaryPIE(UGameViewportClient* InViewport, TOptional<int> PrimaryPIEIndex);
	UNREALED_API void SwitchPrimaryPIE(FWorldContext* OldPrimaryWorld, FWorldContext* NewPrimaryWorld);
	// END META SECTION - VR MultiPlayer
