...
private:
	...
	*/
	...
	/** 
	* When running multiple player windows in multiple processes, this option determins how HMD(s)/Simulator(s) is/are attached to processes.
	* 
	...
	*/
	...
	UPROPERTY(config, EditAnywhere, Category = "Multiplayer Options", meta = (DisplayName = "Set Active PIE To Primary", EditCondition = "RunUnderOneProcess"))
	...
	UPROPERTY(config, EditAnywhere, Category = "Multiplayer Options", meta = (DisplayName = "Set CVar PIE To Primary", EditCondition = "RunUnderOneProcess"))
...
public:
	...
	bool IsSetActivePIEToPrimary() const { return bSetActivePIEToPrimary; }
	bool IsSetCVarPIEToPrimary() const { return bSetCVarPIEToPrimary; }
