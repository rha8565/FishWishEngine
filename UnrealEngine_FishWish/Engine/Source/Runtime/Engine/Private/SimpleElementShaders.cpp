...
void FSimpleElementVS::SetParameters(FRHIBatchedShaderParameters& BatchedParameters, const FRelativeViewMatrices Matrices[2])
{
	...
	SetShaderValue(BatchedParameters, TransformTilePosition, Matrices[0].TilePosition);
}
