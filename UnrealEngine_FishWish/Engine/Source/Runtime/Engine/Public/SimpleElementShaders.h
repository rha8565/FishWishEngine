...
public:
	...
	ENGINE_API void SetParameters(FRHIBatchedShaderParameters& BatchedParameters, const FRelativeViewMatrices Matrices[2]);
	...
	UE_DEPRECATED(5.3, "SetParameters with FRHIBatchedShaderParameters should be used.")
	ENGINE_API void SetParameters(FRHICommandList& RHICmdList, const FRelativeViewMatrices Matrices[2]);
